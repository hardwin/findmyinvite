...
-- service_role only. Approve + queue in one transaction; reject never touches replication_queue.
-- Applied on prod findmyinvite (qqvcptjkfcjkwbkookcm) as shortlist_decide_rpcs.
