...
export default function InvitationHero({data,template,language}:{data:InviteData;template:string;language:boolean}){
 ...
 <div className="hero-person"><h1>{data.groom}</h1><p className="couple-subtext">{data.groomDetails}</p></div>
 {dark?<div className="hero-diamond"><i/><b/><i/></div>:<p className="couple-amp">&</p>}
 <div className="hero-person bride-person"><h1>{data.bride}</h1><p className="couple-subtext">{data.brideDetails}</p></div>
