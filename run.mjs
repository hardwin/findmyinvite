...
const config={plugins:[localApi()],configFile:false,base:'/',appType:'spa',resolve:{preserveSymlinks:true},root:process.cwd(),esbuild:{jsx:'automatic'},server:{host:'127.0.0.1',port:5173},optimizeDeps:{esbuildOptions:{preserveSymlinks:true},include:['react','react-dom/client','react/jsx-runtime','lucide-react','three']}};
