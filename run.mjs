...
const config={plugins:[localApi()],configFile:false,base:'/',appType:'spa',resolve:{preserveSymlinks:true},root:process.cwd(),esbuild:{jsx:'automatic'},server:{host:'127.0.0.1',port:5173},optimizeDeps:{include:["react","react-dom","react/jsx-runtime","react/jsx-dev-runtime"]}};
