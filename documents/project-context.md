...
| Serving production commit (2026-09-25) | `1104543` Assembly Chat mix_image fix (xAI Imagine + dangling tool results) |
| Live bundle | `/assets/index-P8NPzIOj.js` (API-only ship; hash unchanged from prior) |
