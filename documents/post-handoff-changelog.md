...
- RH8 music mux (2026-09-21, PR #22, **not published**): Instagram reel audio (`DS15ecUkpOA`) muxed onto `royal-heritage-8.mp4` (opening) and `royal-heritage-8-hero.mp4` (hero). Video stream copied unchanged; 62.58s source trimmed to 12.04s / 6.04s with 0.25s fade-in and 0.40s fade-out. Catalogue preview stays silent (`-an` product pattern). Display name **Sita Kalyanam**, id `royal-heritage-8`. STOPPED before Publish.
- RH8 demo music (2026-09-21, PR #22, **not published**): player still mutes the videos and was playing parent `/assets/track3.mp3`. Full reel audio extracted to `public/assets/royal-heritage-8-music.mp3` and mapped on the Sita Kalyanam catalog row. Demo `/invite/demo?template=royal-heritage-8` now loops the reel track. STOPPED before Publish.
