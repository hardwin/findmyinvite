...
test('known invitation slugs return unique 200 HTML with brief title, H1 and body',async()=>{
 ...
 assert.match(String(heritage.body),/<title>Royal Heritage Wedding Invitation \| FindMyInvite<\/title>/);
 assert.match(String(heritage.body),/<h1>Royal Heritage Wedding Invitation<\/h1>/);
 assert.match(String(heritage.body),/\/create\?template=royal-heritage&amp;type=wedding/);
 assert.match(String(heritageWedding.body),/<title>Royal Heritage Wedding Template \| FindMyInvite<\/title>/);
 assert.match(String(heritageWedding.body),/<h1>Royal Heritage Wedding Template<\/h1>/);
 assert.match(String(heritageWedding.body),/<meta property="og:title" content="Royal Heritage Wedding Template \| FindMyInvite"/);
 assert.match(String(heritageWedding.body),/<meta name="twitter:title" content="Royal Heritage Wedding Template \| FindMyInvite"/);
 ...
 assert.equal(String(heritage.body).includes('Royal Heritage Wedding Template'),false);
