...
export const BASE_PROMPTS=Object.freeze({
 ...
 opening:OPENING_MOTION_PREFIX+' Vertical 9:16, 15 seconds. Initial closed doors FILL the entire frame. Theme: {WORLD_SETTING}, {PALETTE}, {PAPER_GROUND}. Couple: {COUPLE_LOOKS}. '+OPENING_DIRECTION+' '+OPENING_SAVE_THE_DATE+' '+OPENING_MOTION_SUFFIX
});
...
export function buildPrompts(overrides={}){
 ...
 return {
  ...
  opening:overrides.approvedOpeningPrompt||ensurePromptAffixes('opening','Vertical 9:16, 15 seconds. FIRST: '+p.openingFirst+'. Reveal mechanics: '+openBeat+'. Theme journey: '+p.openingRoute+'. Final couple styling and pose: '+p.lastPose+'. '+OPENING_DIRECTION+' '+OPENING_SAVE_THE_DATE,revealType),
  params:{...p,revealType},
  source:'defaults'
 };
}
