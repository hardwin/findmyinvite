...
const reserved=new Set(['grand-launch','create','dashboard','gallery','templates','login','signup','forgot-password','about','contact','privacy-policy','terms','refund-policy','shipping-policy','blog','demo','admin','manage','invite','akay','invitations','studio']);
