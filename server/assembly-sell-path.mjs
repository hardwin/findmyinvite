...
export function buildStoryboardStillPrompt({
 ...
 if(which==='last'){
  return [
   ...
   'Exactly one adult bride and one adult groom, both recognizable with sharp faces and all identity/wardrobe details preserved. Use the approved theme-specific pose and accessories; no default facing-each-other handholding. Both retain matching wedding footwear; groom in closed-toe formal shoes, no bare feet or missing shoes. Invitation-poster quality.',
 ...
 return [
  ...
  'Edit pin into FIRST FRAME reveal hook — vertical 9:16. The reveal fills the frame and is FULLY CLOSED/SEALED with no gap or interior visible. No people, no faces, no text, no watermark.',
